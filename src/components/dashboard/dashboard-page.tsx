                ...
                <AreaChart data={completionData}>
                  <defs>
                    <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="oklch(0.508 0.118 163.83)" stopOpacity={0.3} />
                      <stop offset="95%" stopColor="oklch(0.508 0.118 163.83)" stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  ...
                  <Area
                    type="monotone"
                    dataKey="value"
                    stroke="oklch(0.508 0.118 163.83)"
                    strokeWidth={2}
                    fill="url(#colorValue)"
                  />
                </AreaChart>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={completionData}>
                  ...
                  />
                  <Bar dataKey="value" fill="oklch(0.508 0.118 163.83)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={userGrowthData}>
                  ...
                  />
                  <Bar dataKey="students" fill="oklch(0.508 0.118 163.83)" radius={[4, 4, 0, 0]} name="Students" />
                  <Bar dataKey="professors" fill="oklch(0.6 0.118 184.704)" radius={[4, 4, 0, 0]} name="Professors" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
